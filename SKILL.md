---
name: gongwen
description: "党政机关公文写作排版技能。用户提供公文类型+事由内容，AI 按 GB/T 9704-2012 生成排版完成的 .docx。覆盖15种文种(通知/报告/请示/批复/函/纪要/命令/决定/决议/公报/公告/通告/通报/意见/议案)，支持版头版记页码、格式自检修复、Markdown降级。触发词: 写公文, 公文, 通知, 报告, 请示, 批复, 函, 纪要, 红头文件."
license: MIT
---
